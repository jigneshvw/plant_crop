...
data_path = os.getcwd()+'/Data/cattle_dataset2/train/'
data_path_valid = os.getcwd()+'/Data/cattle_dataset2/valid/'
data_path_test = os.getcwd()+'//Data/cattle_dataset2/test/'
...
model.load_weights('model_best_weights_dataset2.h5')
...
print(model.summary())
#model.save('cattleclassivgg1.hdf5')
